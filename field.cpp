...
Field::Field(int width, int height) : mWidth(width), mHeight(height),_engine(Ball(QPointF(100,100),3,QPointF(0,1)),
              PhysicsPolygon(QList<QPointF>(
                  {QPointF(50,50),QPointF(150,50),QPointF(150,150),QPointF(50,150)}
