...
static constexpr auto qt_meta_stringdata_ZN5FieldE = QtMocHelpers::stringData(
    "Field",
    "onTic",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN5FieldE[] = {
...
Q_CONSTINIT const QMetaObject Field::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN5FieldE.offsetsAndSizes,
    qt_meta_data_ZN5FieldE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN5FieldE_t,
        // Q_OBJECT / Q_GADGET
...
void *Field::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN5FieldE.stringdata0))
